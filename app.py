...
def compliments_results():
    ...
    context = {
        ...
        'list_of_compliments': random.sample(list_of_compliments, num_compliments)
    }
...
def animal_facts():
    ...
    context = {
        ...
        # get all the names of the animals in a list
        'animal_chosen': request.args.get('animal'),
        'animal_names': animal_to_fact.keys(),
        # set the facts to the dictionary
...
def image_filter():
    ...
    if request.method == 'POST':
        ...
        filter_type = ''
        filter_chosen = requests.post('http://127.0.0.1:5000/image_filter')
